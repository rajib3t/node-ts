...
const resetPassword = function(firstname?:string, token?:string)
{
                  ...
                  <tr>
                    <td class="sm-px-24"
                      ...
                      <p style="margin: 0 0 24px;">
                        Given below the password reset link for update new password. Link will be expired after 10 minitus.  
                      </p>
                      
                      <a href="${process.env.FRONTEND_BASE_URL}/admin/response-reset-password/${token}" target="_blanck">Reset Link</a>
                      ...
                      <p style="margin: 0 0 16px;">
                        ...
                        <a href="mailto:${process.env.APP_EMAIL}" class="hover-underline"
                          style="--text-opacity: 1; color: #7367f0; text-decoration: none;">${process.env.APP_EMAIL}</a>.
                      </p>
                    </td>
                  </tr>
                  <tr>
